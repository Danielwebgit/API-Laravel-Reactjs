...
<div class='subject'>Cloud Money Money </br><strong>Credit Card Checkout</strong></div>
...
<div class='checkout'>
    <div class='order'>
        ...
        <ul class='order-list'>
            ...
            <li>
                <input type="checkbox" name="bike" value="on">
                <h4>Jordan Eclipse</h4><h5>$110</h5>
                <img src='http://images.nike.com/is/image/DotCom/PDP_THUMB/JORDAN-ECLIPSE-724010_401_A_PREM.jpg'></li>
<?php } ?>
        </ul>

        <h5>Shipping</h5><h4>$ 9.50</h4>
        <input type='text' id='cardnumber' name='cardnumber' placeholder='Insira seu valor' pattern='\d*' title='Card Number' />
